...
Python runtime. SAM3's11semantic lifecycle output sets match the original; SAM3.1's11now match
an explicitly endpoint-repaired reference with verified TF32 settings. Historical
