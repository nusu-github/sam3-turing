...
for mode in ['exact','kitchen','kitchen_rot','kitchen_all','kitchen_rot_all','attention_only','global_mlp']:
...
Path('experiments/results/native_rtx2060/kitchen-ba018a0.json').write_text(json.dumps(report,indent=2)+'\n')
