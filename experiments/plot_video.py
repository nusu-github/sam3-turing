...
rows = [
    ...
    (
        "INT8 + CPU trim + ViT/decoder compile",
        "video_fp16_int8_cpu_trim_compile_decoder_b1",
    ),
    (
        "ViT + full detector compile / CPU trim",
        "video_fp16_int8_cpu_trim_compile_detector_b1",
    ),
    ("All components compiled / CPU trim", "video_fp16_int8_cpu_trim_compile_all_b1"),
    (
        "All components / efficient attention",
        "video_fp16_int8_cpu_trim_compile_all_efficient_b1",
    ),
]
metrics = [
...
fig, (left, right) = plt.subplots(1, 2, figsize=(12.8, 8.5), sharey=True)
colors = (
    ["#8b96a5"]
    + ["#447bc5"] * 3
    + ["#20875b"]
