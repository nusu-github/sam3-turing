...
def main():
    ...
    report = {
        ...
        "benchmark_environment": {key: env.get(key) for key in (
            ...
            "SAM3_EXPERIMENT_FC2_NORM",
            "SAM3_EXPERIMENT_INT4_FC2", "SAM3_EXPERIMENT_KITCHEN_LAYOUT", "SAM3_EXPERIMENT_PIXEL", "SAM3_EXPERIMENT_MLP_SCOPE",
        )},
